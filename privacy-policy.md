# PRIVACY POLICY FOR BABY SLEEP SOUNDS

This privacy policy governs your use of the software application Baby Sleep Sounds (“Application”) for mobile devices
that was created by Protect. The Application is designed to play different types of white noise in a loop.

# What information does the Application obtain and how is it used?

The Application allows a user to select different types of pre-recorded white noise and play them back in a loop.
Previous user selections may be saved for user sessions. This user data remains on the device and is not transmitted
off of the  device.
