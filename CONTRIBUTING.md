How to Submit Patches to the Baby Sleep Sounds Project
===============================================================================
https://github.com/brarcher/budget-watch

This document is intended to act as a guide to help you contribute to the
Baby Sleep Sounds project.  It is not perfect, and there will always be exceptions
...
The Baby Sleep Sounds code uses a fair number of unit tests to verify that
...
and potentially merged into the main Baby Sleep Sounds repository. The preferred
way to do this is to submit a Pull Request to the Baby Sleep Sounds project.
